...
<video src="/assets/videos/app_zoom_area_selection.mp4" class="help-video" muted loop autoplay></video>

Adjust the zoom scale on this window or use the settings menu.

<video src="/assets/videos/app_adjust_zoom_scale.mp4" class="help-video" muted loop autoplay></video>

The window for zoomed area can be moved and hidden freely.

<video src="/assets/videos/draggable_zoom_window.mp4" class="help-video" muted loop autoplay></video>