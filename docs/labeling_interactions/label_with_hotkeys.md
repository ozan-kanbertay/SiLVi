---
title: Labeling with Keyboard Shortcuts
parent: Labeling Interactions
nav_order: 0
---

# Labeling with Keyboard Shortcuts

First, make sure to upload files for actions and individuals in the [required format]({% link file_formats.md %}).
